...
export default class VertoRTC {
  ...
  onRemoteStream(stream) {
    console.log(
      '🚀 ~ file: VertoRTC.js:114 ~ VertoRTC ~ onRemoteStream ~ stream:',
      stream,
    );
    const {
    ...
    console.log(
      '🚀 ~ file: VertoRTC.js:119 ~ VertoRTC ~ onRemoteStream ~ element:',
      element,
    );
    if (element) {
  ...
  inviteRemotePeerConnection() {
    ...
    const handleStream = stream => {
      ...
      // Uyen
      const a = screen ? screenPeerConstraints : this.getPeerConstraints();
      console.log(
        '🚀 ~ file: VertoRTC.js:336 ~ VertoRTC ~ handleStream ~ a:',
        a,
      );
      ...
      this.options.callbacks.onPeerStreaming(stream);
      console.log(
        '🚀 ~ file: VertoRTC.js:339 ~ VertoRTC ~ handleStream ~ this.options.callbacks:',
        this.options.callbacks,
      );
      // Uyen cmt and add more code
      // if (this.options.mediaHandlers.playLocalVideo) {
      //   this.options.mediaHandlers.playLocalVideo(stream);
      // } else {
